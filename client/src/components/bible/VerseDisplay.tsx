...
export function VerseDisplay({
  ...
  const getVerseShareText = (verseIndex: number, includeUrl = false) => {
    ...
    if (includeUrl) {
      return `${baseText}\nhttps://play.google.com/store/apps/details?id=com.estampalos.sagradabiblia&pcampaignid=web_share`;
    }
    return baseText;
  };
  ...
  const shareOnFacebook = (verseIndex: number) => {
    ...
    const url = encodeURIComponent('https://play.google.com/store/apps/details?id=com.estampalos.sagradabiblia&pcampaignid=web_share');
